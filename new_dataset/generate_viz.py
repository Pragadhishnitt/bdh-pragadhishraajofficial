...
def generate_visualizations(checkpoint_path: str, output_dir: str = "output"):
    ...
    # Load hebbian results if available and plot SEC/SPS
    results_path = os.path.join(output_dir, "hebbian_results.json")
    if os.path.exists(results_path):
        print(f"\n4. Loading hebbian results: {results_path}")
        ...
        # Plot SPS curve if data available
        if VIZ_AVAILABLE and 'sps_snapshots' in results:
            print("\n5. Plotting SPS curve...")
            try:
